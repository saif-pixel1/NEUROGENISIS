# NEUROGENESIS — Self-Evolving Machine Learning

**NEUROGENESIS** is a prototype framework for machine-learning systems that adapt to changing data streams while preserving previously learned knowledge.
